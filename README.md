...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zhoo4ou.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zhoo4ou.containers.anotherwebservice.com/
...
```
git clone git@github.com:zulfiqarlaili/container-zhoo4ou.git
cd container-zhoo4ou
```
...
```
docker attach container-zhoo4ou
```
